...
\begin{figure}[H]
	\centering
	\includegraphics[height= 15cm]{Circuit}
...
\begin{figure}[H]
	\centering
	\includegraphics[height= 13cm]{Flowchart2}
...
\begin{figure}[H]
	\centering
	\subfloat[Polycarbonate \label{fig:m3}]{\includegraphics[height= 5cm]{M3}} \hspace{1cm}
	\subfloat[Motors were fortify with aluminum \label{fig:m4}]{\includegraphics[height= 5cm]{M4}}
...
\begin{figure}[H]
	\centering
	\subfloat[Model of a scissor lift \label{fig:m5}]{\includegraphics[height= 5cm]{M5}} \hspace{1cm}
	\subfloat[Scissor lift \label{fig:m6}]{\includegraphics[height= 5cm]{M6}} \\ \vspace{0.5cm}
...
\begin{figure}[H]
	\centering
	\includegraphics[height= 5cm]{com}
...
\begin{figure}[H]
	\centering
	\subfloat[ 
	\label{fig:deli1}]{\includegraphics[height= 3cm]{deli1}} \hspace{1cm}
	\subfloat[ 
	\label{fig:deli2}]{\includegraphics[height= 4cm]{deli2}} \\ \vspace{0.5cm}
	\subfloat[ 
	\label{fig:deli3}]{\includegraphics[height= 4cm]{deli3}}
	\hspace{1cm}
	\subfloat[
	\label{fig:deli4}]{\includegraphics[height= 3cm]{deli4}} \\ \vspace{0.5cm}
	\subfloat[
	\label{fig:deli5}]{\includegraphics[height= 3cm]{deli5}}
	\hspace{1cm}
	\subfloat[
	\label{fig:deli6}]{\includegraphics[height= 3cm]{deli6}} \\
...
\begin{figure}[H]
	\centering
	\subfloat[
	\label{fig:ob1}]{\includegraphics[height= 5cm]{ob1}} \hspace{1cm}
	\subfloat[
	\label{fig:ob2}]{\includegraphics[height= 5cm]{ob2}}
	\hspace{1cm}
	\subfloat[
	\label{fig:ob3}]{\includegraphics[height= 5cm]{ob3}}
...
\begin{figure}[H]
	\centering
	\subfloat[ 
	\label{fig:li1}]{\includegraphics[height= 5cm]{li1}} \hspace{1cm}
	\subfloat[ 
	\label{fig:li2}]{\includegraphics[height= 4cm]{li2}} \\ \vspace{0.5cm}
	\subfloat[ 
	\label{fig:li3}]{\includegraphics[height= 4cm]{li3}}
	\hspace{1cm}
	\subfloat[
	\label{fig:li4}]{\includegraphics[height= 5cm]{li4}} \\ 
...
\texttt{\lstinputlisting{Arduino.ino}}
\subsection{ESP Code} \label{sub:ecode}
\texttt{\lstinputlisting{ESP.ino}}
